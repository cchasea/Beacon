...
Future<int> queryNPSCollectionRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      NPSCollectionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NPSCollectionRecord>> queryNPSCollectionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      NPSCollectionRecord.collection,
      NPSCollectionRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NPSCollectionRecord>> queryNPSCollectionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
