...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3E7BFA);
  late Color secondary = const Color(0xFF80A6E3);
  late Color tertiary = const Color(0xFF000000);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF3E7BFA);
  late Color secondaryBackground = const Color(0xFF80A6E3);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF000000);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFAF8F8);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF3E7BFA);
  late Color secondaryBackground = const Color(0xFF80A6E3);
  late Color accent1 = const Color(0xFD010007);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
