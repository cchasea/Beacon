...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('Profile_custom_action');
                          ...
                          builder: (context) => Container(
                            ...
                            child: Align(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'PROFILE_PAGE_addPicButton_ON_TAP');
                                  logFirebaseEvent(
                                      'addPicButton_upload_media_to_firebase');
                                  final selectedMedia =
                                  ...
                                  logFirebaseEvent('addPicButton_backend_call');
                  ...
                  AuthUserStreamWidget(
                    builder: (context) => FlutterFlowDropDown<String>(
                      controller: _model.roleValueController ??=
                        ...
                        _model.roleValue ??= valueOrDefault(currentUserDocument?.role, '') !=
                                    ''
                            ? valueOrDefault(currentUserDocument?.role, '')
                            : '',
                      ),
                      options:
                          List<String>.from(['Student', 'Educator', 'General']),
                      optionLabels: ['Student', 'Educator', 'General'],
                      onChanged: (val) =>
                                ...
                                Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Align(
                                        alignment:
                                            AlignmentDirectional(0.68, 0.06),
                                        child: Padding(
                                          padding:
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('PROFILE_PAGE_update_button_ON_TAP');
                          logFirebaseEvent('update_button_backend_call');
                          ...
                          logFirebaseEvent(
                              'update_button_google_analytics_event');
                          logFirebaseEvent(
                            'role_selected',
                            parameters: {
                              'role': _model.roleValue,
                          ...
                          logFirebaseEvent('update_button_navigate_to');
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('PROFILE_PAGE_doLater_text_ON_TAP');
                          logFirebaseEvent('doLater_text_navigate_to');
