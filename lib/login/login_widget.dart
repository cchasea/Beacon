                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'LOGIN_PAGE_forgot_password_text_ON_TAP');
                            logFirebaseEvent('forgot_password_text_auth');
                            if (_model
                ...
                Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('LOGIN_PAGE_SignUp_text_ON_TAP');
                        logFirebaseEvent('SignUp_text_navigate_to');
